...
<section class="hero" data-area="hero">
  <div class="wrap">
    <div>
      ...
      <h1>クルマに関するすべてを、<br>ワンストップで。</h1>
      <p class="hero__lead">新車を買うところから、車検、修理、板金、保険まで、うちで全部お受けします。スズキ・ダイハツの代理店ですが、国産車は全メーカー、輸入車の車検・整備もお受けします。岡山市中区高屋で60年、同じ場所でやってきました。</p>
      <ul class="pills">
