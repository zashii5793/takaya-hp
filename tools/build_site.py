...
SERVICES = [
    ...
    ("cars", "01", "おクルマを探す・買い取る", "新車は日本車の全メーカー。中古車はご希望条件で業者オークションから探すオーダー形式。", "cars", ""),
...
<section class="hero" data-area="hero">
  <div class="wrap">
    <div>
      ...
      <h1>おクルマに関するすべてを、<br>ワンストップで。</h1>
      <p class="hero__lead">新車を買うところから、車検、修理、板金、保険まで、すべて当社でお受けします。スズキ・ダイハツの代理店ですが、国産車は全メーカー、輸入車の車検・整備もお受けします。岡山市中区高屋で60年、同じ場所でやってきました。</p>
      <ul class="pills">
...
<section class="sec" id="about">
  <div class="wrap split">
    <div>
      ...
      <h2 class="sec-title">岡山市中区で60年。<br>おクルマのことを、まとめて相談できる会社です。</h2>
      <p class="lead">タカヤモーター（昭和40年創立）とタカヤリース（昭和59年創立）の2社で、新車・中古車の販売、買取、リース、車検・整備、板金塗装、自動車保険まで、おクルマのことをまとめてお受けしています。スズキ・ダイハツの代理店ですが、国産車は全メーカー、輸入車の整備もお受けします。</p>
...
<section class="sec"><div class="wrap">
  <h2 class="sec-title">おクルマのことは、この5つの窓口でまとめてお受けします</h2>
